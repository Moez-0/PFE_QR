...
const Hero = () => {
  return (
    <div className='mt-20 min-h-screen min-w-full bg-white dark:bg-slate-950 flex text-black dark:text-white flex-col md:flex-row '>
      ...
      cursor={true}
      repeat={Infinity} /></h1>
        <p className='mb-5 md:text-xl px-6 md:px-0'>BoxHero is a powerful inventory management software that helps you manage your inventory more efficiently and accurately.</p>
        <button className='bg-blue-600 text-white px-4 py-2 rounded-md mt-5 md:text-xl'>Get Started</button>
        </div>
