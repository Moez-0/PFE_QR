  ...
  return (
    ...
    <div className='shadow-inner shadow-4xl min-h-screen min-w-full bg-[#F8F8FC] dark:bg-slate-900 flex text-black dark:text-white flex-col md:flex-row'>
        ...
        <div className='right flex-1 mr-[20%] flex flex-col justify-center items-center md:items-start f ml-5 mr-10'>
            <h1 className='md:text-8xl text-xl font-bold mb-5'><span className='bg-gradient-to-r from-blue-600 via-indigo-800 to-main inline-block text-transparent bg-clip-text'>Trusted by </span> Companies of All Sizes</h1>
            <p className='text-xl'>Over 200,000 Users across 90 Countries Worldwide</p>
        </div>
