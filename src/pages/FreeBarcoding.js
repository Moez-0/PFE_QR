  ...
  return (
    ...
    <TypeAnimation
      sequence={[
        'Free', // Types 'One'
        1000, // Waits 1s
        "Barcode", // Deletes 'One' and types 'Two'
        2000, // Waits 2s
        'Generator.', // Types 'Three' without deleting 'Two'
        () => {
...
Our system supports all types of label sheets and printers.</p>
    ...
    <Link to='printing' className='bg-blue-600 text-white px-4 py-2 rounded-md mt-5'>Get Started</Link>
    </div>
